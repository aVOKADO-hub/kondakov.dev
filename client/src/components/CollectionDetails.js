...
function CollectionDetails({ setCollectionName }) {
    ...
    const handleCreateDocument = async (e) => {
        e.preventDefault();
        try {
            alert(newDocument.responsible_person)
            alert(newDocument.rank)
            alert(newDocument.stressLevel)
            alert(newDocument.serviceSatisfaction)
            alert(newDocument.workLifeBalance)
